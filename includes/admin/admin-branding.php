...
add_filter( 'login_headertitle', 'child_login_headertitle' );
/**
 * Makes the login screen's logo title attribute your site title, instead of 'WordPress'.
 *
 * @since 1.0
 */
function child_login_headertitle() {

	return get_bloginfo( 'name' );

}

// add_action( 'login_enqueue_scripts', 'child_replace_login_logo' );
/**
 ...
 * @since 1.0
 */
function child_replace_login_logo() {
...
add_filter( 'wp_mail_from_name', 'child_mail_from_name' );
/**
 * Makes WordPress-generated emails appear 'from' your WordPress site name, instead of from 'WordPress'.
 *
 * @since 1.0
 */
function child_mail_from_name() {

	return get_option( 'blogname' );

}

// add_filter( 'wp_mail_from', 'child_wp_mail_from' );
/**
 ...
 * @since 1.0
 */
function child_wp_mail_from() {

	return get_option( 'admin_email' );

}

// add_filter( 'mandrill_payload', 'child_force_mandrill_payload_to_html' );
/**
 ...
 * @since 1.0
 */
function child_force_mandrill_payload_to_html( $message ) {
...
add_filter( 'retrieve_password_message', 'child_cleanup_retrieve_password_message' );
/**
 * Remove the brackets from the retreive PW link, since they get hidden on HTML.
 *
 * @since 1.0
 */
function child_cleanup_retrieve_password_message( $message ) {

	return preg_replace( '/<(.+?)>/', '$1', $message );

}

// add_action( 'wp_before_admin_bar_render', 'child_remove_wp_icon_from_admin_bar' );
/**
 ...
 * @since 1.0
 */
function child_remove_wp_icon_from_admin_bar() {
...
// add_filter( 'admin_footer_text', 'child_admin_footer_text' );
/**
 ...
 * @since 1.0
 */
function child_admin_footer_text() {
